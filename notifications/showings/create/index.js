...
module.exports = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    const { buyerUser, listingId, scheduled, isExample } = snap.data();
    ...
    try {
      ...
      functions.logger.log('lisdfsdfsdfsting', listing);
      ...
      functions.logger.log({
        ...
        scheduledTime: new Date(scheduled.seconds * 1000).toLocaleString(),
        listingAddress: listing.fullAddress,
      });
      await sendEmail(sellerEmail, 'd-619ecacba28545f6b145402668997bcc', {
        buyerDisplayName: buyerUser.displayName,
        sellerDisplayName: sellerDisplayName,
        scheduledTime: new Date(scheduled.seconds * 1000).toLocaleString(),
        listingAddress: listing.fullAddress,
